package lead.caracteristicas 
{
	 ...
	 */
	public class AnimaCaracteristicas extends MovieClip
	{
		...
		public function AnimaCaracteristicas() 
		{
			super();
		}
		...
		{
			arrayItens = new Array(item1, item2, item3, item4);
			arrayPosX = new Array();
			arrayPosY = new Array();
